		...
		return '
			<div class="acf-paypal-item-settings">
				<div class="control-group">
					...
					<div class="controls">
						<input id="' . $this->id . '_item_name" type="text" name="' . $this->name . '[item_name]" value="' . $itemName . '" placeholder="' . JText::_('ACF_PAYPAL_ITEM_NAME_HINT') . '" class="form-control input-xlarge w-100"' . $requiredAtt . ($this->disabled ? ' disabled' : '') . ' />
					</div>
				</div>
				<div class="control-group">
					<div class="control-label">
					...
					<div class="controls">
						<input id="' . $this->id . '_price" type="text" name="' . $this->name . '[price]" value="' . $price . '" placeholder="' . JText::_('ACF_PAYPAL_PRICE_HINT') . '" class="form-control input-xlarge w-100"' . $requiredAtt . ($this->disabled ? ' disabled' : '') . ' />
					</div>
				</div>
			</div>
		';
